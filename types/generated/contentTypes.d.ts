...
export interface ApiAccordionAccordion extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    block_content: Schema.Attribute.Relation<
      'manyToOne',
      'api::block-content.block-content'
    >;
...
export interface ApiBlockContentBlockContent
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    accordions: Schema.Attribute.Relation<
      'oneToMany',
      'api::accordion.accordion'
    >;
    content: Schema.Attribute.Blocks;
...
export interface ApiComponentWithLinkComponentWithLink
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::component-with-link.component-with-link'
    > &
      Schema.Attribute.Private;
    page: Schema.Attribute.Relation<'oneToOne', 'api::page.page'>;
    picture: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::page.page'> &
      Schema.Attribute.Private;
    page_id: Schema.Attribute.UID<'title'>;
    publishedAt: Schema.Attribute.DateTime;
